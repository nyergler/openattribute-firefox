...
var URIjoin = Util.uri.join
var uri_docpart = Util.uri.docpart
var uri_protocol = Util.uri.protocol
...
var RDFArrayRemove = function(a, x) {  //removes all elements equal to x from a
...
if (typeof(__RDFA_BASE) == 'undefined')
  var __RDFA_BASE = 'http://www.w3.org/2006/07/SWD/RDFa/impl/js/';
...
RDFA.each_prefixed_attr_value = function(attr_values, attr_val_func) {
  return RDFA.each_attr_value(attr_values, function(attr_value) {
	...
	// Commented by Igor Lukanin. Otherwise the triplestore doesn't get populated
